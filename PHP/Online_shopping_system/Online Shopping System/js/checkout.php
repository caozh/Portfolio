<?php
    ...
    function insertDB () {
        ...
        //echo 'UserID: '.$userID.'<br>Amount: '.$getAmount;
        //insert data into database
        $sql = "INSERT INTO ORDERS (BuyerID, Amount)
                           VALUES ('$userID','$getAmount')";
        if ($mysqli->query($sql) === TRUE) {
            $msg = '<b>Place order successfully</b>';
    ...
    function loadCartInfo() {
        global $userID,$msg,$amount,$productCounter;
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="single-product.php?uid=<?php      echo $userID.'&pid='.$productID;?>">Single product</a></li>
                        <li class="active"><a href="cart.php?uid=<?php echo $userID.'&pid='.$productID;?>">Cart</a></li>
                        <li><a href="checkout.php?uid=<?php            echo $userID.'&pid='.$productID;?>">Checkout</a></li>
