<?php
    ...
    //check if user id is passed to this page
    function checkPost() {
        global $userID;
        ...
        if ($result = $mysqli->query($sql)){
            ...
            if ($row_cnt == 0){
                ...
                while ($row = $result->fetch_assoc()){
                    ...
                    $productName = loadProductName($row['ProductID']);
                    ...
                    <tr class="cart_item">
                        ...
                        <td class="product-name">
                            <a href="single-product.php?uid='.$row['UserID'].'&pid='.$row['ProductID'].'">'.$productName.'</a> 
                        </td>
                        ...
                        <td class="product-quantity">
                            <div class="quantity buttons_added">
                                ...
                                <input type="number" size="4" class="input-text qty text" title="qty" value="'.$row['Quantity'].'" min="0" step="1">
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            <th>Cart Subtotal</th>
                                            <td><span class="amount">$<?php echo $amount;?>.00</span></td>
                                        </tr>
