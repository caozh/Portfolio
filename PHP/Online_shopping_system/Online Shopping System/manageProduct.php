            ...
            while ($row = $result->fetch_assoc()){
                ...
                echo '
							<h3>Product ID:'.$row['ID'].'</h3>
												...
												Name: 
                                                <br><input type="text" value="'.$row['Name'].'" placeholder="" id="name" name="name" class="input-text ">
                                         
                                    
                        
                                          <br>Owner:
                                                <br><input type="text" value="'.$row['Owner'].'" placeholder="" id="email" name="owner" class="input-text ">
                                           <br>Category :
                                                <br><input type="text" value="'.$row['Category'].'" placeholder="" id="password" name="category" class="input-text ">
                                            <br>Price:
                                                <br><input type="text" value="'.$row['Price'].'" placeholder="" id="phone" name="price" class="input-text ">
                                               <br>
                                             Quantity :
                                                <br><input type="text" value="'.$row['Quantity'].'" placeholder="" id="postcode" name="quantity" class="input-text ">
                                
                                            	<br><img src="'.$row['ImagePath'].'" alt="">
                </br></br>
                <a href="productEdit.php?uid='.$userID.'&pid='.$row['ID'].' "> <h3>Edit Product</h3></a>
                </br> </br></br> </br>';
