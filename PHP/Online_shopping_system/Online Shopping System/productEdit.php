            ...
            ?>
                                            ...
                                            <p id="billing_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                                <label class="" for="billing_city">Description 
                                                 ...
                                                 <textarea cols="30" rows="5" id="order_comments" placeholder="<?php echo $description ;?>" class="input-text " name="order_comments"></textarea>
                                            </p><br>
									...
									<a href="adminHome.php?uid=<?php echo $userID?>"> <h1>Back to home</h1></a>
